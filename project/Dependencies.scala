...
trait Dependencies {
  ...
  val tsecSymmetric     = "io.github.jmcardon"         %% "tsec-symmetric-cipher" % v.tsec
  ...
  val metaParadise   = "org.scalameta"          % "paradise" % "3.0.0-M11" cross CrossVersion.full
  ...
  , betterFiles, macwire, macwireAkka, macwireProxy, macwireUtil, nscalaTime, quicklens
  , scalaCompiler, scalaLibrary, scalaReflect, scalaLogging, scalameta, scalametaContrib, slick
  , slickHikaricp, sttp, tsec, tsecDigest, tsecJwtMac, tsecJwtSig, tsecMac, tsecPassword
  , tsecSignature, tsecSymmetric, akkaHttpTestkit, akkaStreamTestkit, akkaTestkit, mockito
  , scalatest, selenium, slf4jNop, slickTestkit, linter, macrosParadise, metaParadise
